...
\node[font=\sffamily\scriptsize, align=left, text=domteal!80!black] at ([yshift=0.2cm]domain.center) {
    EDA Parsers (6 built-in)\\Plugin Registry (entry points)\\GitHub Source (issue bridge)
};
